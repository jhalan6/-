...
public class Strategy extends JFrame {
	...
	public Strategy() {
		...
		JComboBox comboBox = new JComboBox(new String[]{"无","八折"});
		...
		certernButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (handleSystem.getErrorMessage()!=null) {
					...
					countLable.setText(Float.toString(handleSystem.getResult()));
		...
		showResult.setBounds(6, 109, 306, 99);
